...
Homebrew 6 requires third-party taps to be trusted explicitly before it will load them; `brew trust` records that consent. Skip it and the install stops with "Refusing to load cask ... from untrusted tap".
